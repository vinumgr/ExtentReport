...
public class OrderObjects extends Globals {
	...
	public WebElement menuCategoryClothing;
	...
	public WebElement selectSize_PDP;
	...
	@FindBy(xpath="//div[@class='mini-cart1']")
	...
	@FindBy(xpath="//input[@id='InputBoxpincode']")
	public WebElement pinCodeBeforeCheckout;
	
	@FindBy(xpath="//*[@id='checkout-shipping-address-btn']")
	public WebElement proceedToReview;
	
	@FindBy(xpath="//button[@id='checkout-payment-btn']")
